...
router.get('/category-mapping', function (req, res) {
    res.render('Category/category');
})


router.get('/item-control', function (req, res) {
    res.render('Item-Control/item-control');
})

router.get('/synchronization', function (req, res) {
    res.render('Synchronization/synchronization');
})
